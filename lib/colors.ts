...
export function generateColors(color1: string, color2: string): string[] {
  ...
  let color3 = rgbToHex(avgR + 20, avgB - 20, avgB - 20);
  let color4 = rgbToHex(avgR - 20, avgB + 20, avgB + 20);
  let color5 = rgbToHex(avgR + 10, avgB + 10, avgB - 30);
  let color6 = rgbToHex(avgR - 30, avgB - 10, avgB + 10);
  let color7 = rgbToHex(avgR + 20, avgB - 10, avgB + 20);
