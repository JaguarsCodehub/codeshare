...
-- CreateIndex
CREATE UNIQUE INDEX "View_snippetId_key" ON "View"("snippetId");
...
-- AddForeignKey
ALTER TABLE "View" ADD CONSTRAINT "View_snippetId_fkey" FOREIGN KEY ("snippetId") REFERENCES "snippets"("id") ON DELETE CASCADE ON UPDATE CASCADE;
